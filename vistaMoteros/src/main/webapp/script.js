document.addEventListener('DOMContentLoaded', function() {
    ...
    const nvSignUpClub = document.querySelector('.sign-up-btn.sign-up-club');
    const nvSignUpUser = document.querySelector('.sign-up-btn.sign-up-user');
    ...
    nvSignUpClub.addEventListener('click', function(event) {
        event.preventDefault();
        toggleForm(formClub); // Abre el formulario de registro de clubes
    });

    nvSignUpUser.addEventListener('click', function(event) {
        event.preventDefault();
        toggleForm(formUser); // Abre el formulario de registro de usuarios
    });
